...
1. Используйте этот [API](../../Downloads/swagger.yaml).
...
2. Реализовать gRPC-метод, который просто вернёт все добавленные в систему ПВЗ. Для него не
   ...
   Обратите внимание, что в файле [pvz.proto](../../Downloads/pvz.proto) необходимо прописать go_package под вашу структуру проекта
